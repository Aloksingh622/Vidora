...
export const serverUrl = "https://vidora-mk56.onrender.com"
    ...
    <>
      ...
      <Routes>
        ...
        <Route path='/createpage' element={<ProtectedRoute userData={userData}><CreatePage /></ProtectedRoute>} />
          ...
          <Route path='/AiCreate' element={<ProtectedRoute userData={userData}><AiCreatepage/></ProtectedRoute>} />
          <Route path='/ai-create/generate-thumbnail' element={<ProtectedRoute userData={userData}><GenerateThumbnail/></ProtectedRoute>} />
          <Route path='/ai-create/youtubeanalyze' element={<ProtectedRoute userData={userData}><YouTubeAnalysis/></ProtectedRoute>} />
          <Route path='/summary' element={<ProtectedRoute userData={userData}><Summary/></ProtectedRoute>} />
