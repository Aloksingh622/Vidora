  ...
  return (
    <div className="w-full min-h-screen  text-white flex flex-col">
      ...
      <main className="flex flex-1 justify-center items-center px-4">
        <div className="bg-slate-900/40 backdrop-blur-sm border-2 border-slate-800/50 p-6 sm:p-8 rounded-2xl w-full max-w-lg shadow-2xl">
          {/* Step 1 */}
          {step === 1 && (
            <>
              <h2 className="text-2xl font-bold mb-2">Customize channel</h2>
              ...
              <span
                onClick={() => navigate("/")}
                className="w-full flex items-center justify-center text-sm text-[#795d3f] hover:text-[#8a6a47] cursor-pointer hover:underline mt-3 transition-colors"
              >
                Back to Home Page
              </span>
            </>
          ...
          {step === 2 && (
            <>
              <h2 className="text-2xl font-bold mb-2">Your Updated Channel</h2>
              ...
              <button
                onClick={nextStep}
                className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-[#795d3f] to-[#8a6a47] hover:from-[#6a5038] hover:to-[#795d3f] py-3 rounded-xl font-bold shadow-lg hover:shadow-[#795d3f]/20 transition-all active:scale-95"
              >
          ...
          {step === 3 && (
            <>
              ...
              >
                ...
                <span className="text-[#795d3f] hover:text-[#8a6a47] font-semibold text-sm transition-colors">
                  Upload Banner Image
                </span>
                <input
                  id="banner-upload"
